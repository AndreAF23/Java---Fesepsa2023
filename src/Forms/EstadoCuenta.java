...
public class EstadoCuenta extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for(int i = 0;i<jTable1.getRowCount();i++){
            DatosReportePDF datos = new DatosReportePDF(
        ...
        try{
            ...
            JasperReport reporte = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/prueba2.jasper"));
            Map parametros = new HashMap();
            
            parametros.put("CODC",jTextField1.getText());
            parametros.put("RZNS",jTextField2.getText());
            consulta = "EXEC [dbo].[AF_MANAGE_CRUDCLIE] 3,'CodigoCliente','" + jTextField1.getText() + "','','','RucCliente'";
            parametros.put("RUC",exec.ejecutar(consulta));
            consulta = "EXEC [dbo].[AF_MANAGE_CRUDCLIE] 3,'CodigoCliente','" + jTextField1.getText() + "','','','DireccionCliente'";
            parametros.put("DIR",exec.ejecutar(consulta));
            consulta = "EXEC [dbo].[AF_MANAGE_CRUDCLIE] 3,'CodigoCliente','" + jTextField1.getText() + "','','','Telefono1'";
            parametros.put("TLF",exec.ejecutar(consulta));
            consulta = "EXEC [dbo].[AF_MANAGE_CRUDCLIE] 3,'CodigoCliente','" + jTextField1.getText() + "','','','CorreoCliente'";
            parametros.put("CORR",exec.ejecutar(consulta));
            consulta = "EXEC [dbo].[AF_MANAGE_CRUDCLIE] 3,'CodigoCliente','" + jTextField1.getText() + "','','','CodigoVendedor'";
