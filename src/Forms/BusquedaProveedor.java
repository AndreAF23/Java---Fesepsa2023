...
public class BusquedaProveedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"Razon Social","Código"}));
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        buscar=jTextField1.getText().trim();
        if(tipo.equals("Código")){
            tipo="CodigoProveedor";
        }else{
            tipo="RazonSocialProveedor";
        }
        String consulta="EXEC [dbo].[AF_MANAGE_CRUDPROV] 7,'" + tipo + "','" + buscar + "'";
